...
$hhsearchdb = shift @ARGV; # /home/chengji/casp8/hhsearch1.5/database/hhsearch15db
$min_domain_length = shift @ARGV; # 40
$output_dir = $full_length_dir;
...
{
	if(!(-d "$full_length_dir/hhsearch15"))
	{
		`mkdir -p $full_length_dir/hhsearch15`;
	}
...
#$min_domain_length = 30; #used to judge if a domain is missing (less than 40 will be refined by Rosetta refinement)
$align_id = 0;
