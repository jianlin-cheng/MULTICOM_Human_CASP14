...
my $GLOBAL_PATH;
BEGIN { $GLOBAL_PATH ='/home/jianliu/MULTICOM_Human_CASP14/scripts/hhsearch1.5/'; }
if (@ARGV != 4)
{
...
$hhsearch_dir="/home/jianliu/MULTICOM_Human_CASP14/tools/hhsearch1.5.0/";
...
print("perl $meta_dir/script/rank_templates.pl $filename.hhr $work_dir/$name.rank\n\n");
system("perl $meta_dir/script/rank_templates.pl $filename.hhr $work_dir/$name.rank");

#parse the blast output
print "parse hhsearch output...\n";
print("perl $meta_dir/script/parse_hhsearch.pl $filename.hhr $fasta_file.local\n\n");
system("perl $meta_dir/script/parse_hhsearch.pl $filename.hhr $fasta_file.local");
