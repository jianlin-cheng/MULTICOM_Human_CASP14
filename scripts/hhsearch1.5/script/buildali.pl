...
use lib "/home/jianliu/MULTICOM_Human_CASP14/scripts/hhsearch1.5/script/";
use Align;
# CUSTOMIZE
...
my $dbbase="/home/jianliu/MULTICOM_Human_CASP14/databases/nr70_90/nr"; # will use PSI-BLAST dbs $dbbase."90" and $dbbase."70" 
                                   # It is recommended to use nre = nr + env. 
                                   # 90: filtered with CD-HIT to 90% maximum pairwise sequence identity
my $hh="/home/jianliu/MULTICOM_Human_CASP14/scripts/hhsearch1.5/script/";
my $perl=$hh;
my $ncbidir="/home/jianliu/MULTICOM_Human_CASP14/tools/blast-2.2.17/bin"; # directory with ncbi BLAST binaries
my $blastpgp=$ncbidir."/blastpgp -I T -s T"; # blastpgp executable
#our $blastpgp.=" -I T -s T"; # show gi's in defline; use Smith-Waterman

my $execdir="/home/jianliu/MULTICOM_Human_CASP14/tools/psipred-2.61/bin";  # directory with PSIPRED binaries 
my $datadir="/home/jianliu/MULTICOM_Human_CASP14/tools/psipred-2.61/data"; # directory with PSIPRED data 
###########################################################################################################
