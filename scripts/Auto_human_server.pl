...
#################################################
$ENV{'PATH'}.=':/home/jianliu/MULTICOM_Human_CASP14/tools/i3Drefine/software/jdk1.7.0_01/bin';
$ENV{'CLASSPATH'}.=':/home/jianliu/MULTICOM_Human_CASP14/tools/i3Drefine/software/3Drefine:/home/jianliu/MULTICOM_Human_CASP14/tools/i3Drefine/software/3Drefine/programs';
$tool_TM = '/home/jianliu/MULTICOM_Human_CASP14/tools/tm_score2/TMscore';
if(@ARGV<3)
{
...
my($auto_all) = "/home/jianliu/MULTICOM_Human_CASP14/DeepRank/bin/run_DeepRank.sh"; # use this in casp13
...
print("/home/jianliu/MULTICOM_Human_CASP14/scripts/filter_model_same_group_v2.pl $name.mlist $name.nlist  /home/jianliu/MULTICOM_Human_CASP14/tools/tm_score2/TMscore > $same_group_log\n\n");
system("/home/jianliu/MULTICOM_Human_CASP14/scripts/filter_model_same_group_v2.pl $name.mlist $name.nlist  /home/jianliu/MULTICOM_Human_CASP14/tools/tm_score2/TMscore > $same_group_log");
...
else
{
  if(!(-e $final_ranking3))
  {
    $cmd = "sh /home/jianliu/MULTICOM_Human_CASP14/DeepRank3/bin/DeepRank3_Cluster.sh $targetname $addr_fasta $ren_filter $eva_DeepRank3_dir $dncon4_contactfile $dist_map_file  &> $eva_DeepRank3_dir/run_DeepRank3_Cluster.log";
    print("$cmd\n\n");
	  if(system($cmd))
    {
      print("$cmd fails!\n");
  ...
  if(!(-e $final_ranking4))
  {
    $cmd = "sh /home/jianliu/MULTICOM_Human_CASP14/DeepRank3/bin/DeepRank3_SingleQA_lite.sh $targetname $addr_fasta $ren_filter $eva_DeepRank3_dir $dncon4_contactfile $dist_map_file  &> $eva_DeepRank3_dir/run_DeepRank3_SingleQA_lite.log";
    print("$cmd\n\n");
	  if(system($cmd))
    {
      print("$cmd fails!\n");
  ...
  if(!(-e $final_ranking5))
  {
    $cmd = "sh /home/jianliu/MULTICOM_Human_CASP14/DeepRank3/bin/DeepRank3_SingleQA.sh $targetname $addr_fasta $ren_filter $eva_DeepRank3_dir $dncon4_contactfile $dist_map_file  &> $eva_DeepRank3_dir/run_DeepRank3_SingleQA.log";
    print("$cmd\n\n");
	  if(system($cmd))
    {
      print("$cmd fails!\n");
...
print("perl /home/jianliu/MULTICOM_Human_CASP14/scripts/sort_deep_qa_score.pl $final_ranking1 $final_ranking_old\n\n");
system("perl /home/jianliu/MULTICOM_Human_CASP14/scripts/sort_deep_qa_score.pl $final_ranking1 $final_ranking_old");
...
if(!-s $filtered_model)
{
print "check the output /home/jianliu/MULTICOM_Human_CASP14/DeepRank3/bin/DeepRank3_SingleQA.sh output, $filtered_model!\n";
exit(0);
}
=pod
...
print "\n\n######### now use mufold the to clustering #####\n\n";
my($tool_mufold) = "/home/jianliu/MULTICOM_Human_CASP14/scripts/1_MUFOLD_cluster_for_one_target.pl";
if(!-s $tool_mufold)
{
...
print("perl $tool_mufold $filtered_model /home/jianliu/MULTICOM_Human_CASP14/tools/MUfold_cluster/MUFOLD_CL $mucluster > /dev/null 2>&1\n\n");
if(system("perl $tool_mufold $filtered_model /home/jianliu/MULTICOM_Human_CASP14/tools/MUfold_cluster/MUFOLD_CL $mucluster > /dev/null 2>&1"))
{
print "perl $tool_mufold $filtered_model /home/jianliu/MULTICOM_Human_CASP14/tools/MUfold_cluster/MUFOLD_CL $mucluster fails!\n";
exit(0);
}
...
my($tool_combine) = "/home/jianliu/MULTICOM_Human_CASP14/scripts/global_local_human_2016.pl";
...
my($tool_GDT) = "/home/jianliu/MULTICOM_Human_CASP14/tools/TMscore_32";
    ...
    if ($sim_score < 0.9)
    {
        ...
        #### use self_model.pl or 3Drefine, and recheck
         ...
         if(!(-d $dir_tem_refine))
         {
            ...
            print "/home/jianliu/MULTICOM_Human_CASP14/tools/i3Drefine/bin/i3Drefine.sh   casp${idnew}.norefine.pdb  5 &> casp${idnew}.norefine.pdb.refinelog\n";
            `/home/jianliu/MULTICOM_Human_CASP14/tools/i3Drefine/bin/i3Drefine.sh   casp${idnew}.norefine.pdb  5 &> casp${idnew}.norefine.pdb.refinelog`;
...
print "\n\n##### copy the final five models and add the local quality ####\n\n";
$add_local = "/home/jianliu/MULTICOM_Human_CASP14/scripts/CASP12_human_add_remark_QA.pl";
...
$model_refine_script = "/home/jianliu/MULTICOM_Human_CASP14/scripts/ModRefiner_refine.pl";
$real_refine_script = "/home/jianliu/MULTICOM_Human_CASP14/scripts/Real_run_ModRefiner.pl";
#my($refine_tool) = "/home/jianliu/MULTICOM_Human_CASP14/tools/ModRefiner-l";
$refine_tool = "/home/jianliu/MULTICOM_Human_CASP14/tools/ModRefiner-l";
$refine_TM = "/home/jianliu/MULTICOM_Human_CASP14/tools/TMscore_32";
...
##### now use the new ranking to combine the model using structure similarity #####
print "##### now use the new ranking to combine the model #####\n\n";
$tool_combine = "/home/jianliu/MULTICOM_Human_CASP14/scripts/global_local_human_2016.pl";
...
print "###### compare the GDT score and check the model drifting #######\n\n";
$tool_GDT = "/home/jianliu/MULTICOM_Human_CASP14/tools/TMscore_32";
#my($model1,$model2,$tmp_out);
$tmp_out = $dir_output."/"."TM_tmp";
